...
class BrandedPDFGenerator:
    ...
    def _build_styles(self):
        _base = getSampleStyleSheet()  # noqa: F841
        ...
        custom = {
            ...
            'critical': ParagraphStyle(
                'critical', fontName='Helvetica-Bold', fontSize=9.5,
                textColor=BRAND_RED, leading=14, spaceAfter=3),
            'high': ParagraphStyle(
                'high', fontName='Helvetica-Bold', fontSize=9.5,
    ...
    def _cover_header(self, styles, client_name, period, run_delta):
        data = [
            [Paragraph(f'<b>{client_name}</b>', styles['cover_title']),
             Paragraph('VALINOR', ParagraphStyle(
            ...
            [Paragraph(f'Análisis de Inteligencia de Negocio · {period}', styles['cover_sub']),
             Paragraph(datetime.utcnow().strftime('%d/%m/%Y'), ParagraphStyle(
    ...
    def _dq_checks_table(self, checks: list) -> Table:
        ...
        header_style = ParagraphStyle(
            'dqch', fontName='Helvetica-Bold', fontSize=7.5, textColor=WHITE)
        cell_style = ParagraphStyle(
            'dqcc', fontName='Helvetica', fontSize=7.5, textColor=BRAND_DARK)
        ok_style = ParagraphStyle(
            'dqco', fontName='Helvetica-Bold', fontSize=7.5, textColor=DQ_GREEN)
        fail_style = ParagraphStyle(
            'dqcf', fontName='Helvetica-Bold', fontSize=7.5, textColor=DQ_RED)
    ...
    def _audit_table(self, styles, dq: dict, snapshot_ts: str):
        ...
        header_style = ParagraphStyle(
            'ath', fontName='Helvetica-Bold', fontSize=8, textColor=WHITE)
        cell_style = ParagraphStyle(
            'atc', fontName='Helvetica', fontSize=8, textColor=BRAND_DARK)
        ok_style = ParagraphStyle(
            'atk', fontName='Helvetica-Bold', fontSize=8, textColor=DQ_GREEN)
    ...
    def _build_provenance_footer_table(self, results: dict) -> Table:
        ...
        cell_style = ParagraphStyle(
            'pf_cell', fontName='Helvetica', fontSize=7.5, textColor=BRAND_DARK)
        title_style = ParagraphStyle(
            'pf_title', fontName='Helvetica-Bold', fontSize=8, textColor=BRAND_DARK)
    ...
    def _triggered_alerts_section(self, styles, alerts: list) -> Table:
        ...
        """
        title_style = ParagraphStyle(
            'alrt_title', fontName='Helvetica-Bold', fontSize=9, textColor=BRAND_DARK)
