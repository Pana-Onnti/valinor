...
from api.net_guard import validate_outbound_host as _validate_ssh_host
...
# SSRF guard for outbound DB/SSH hosts now lives in api/net_guard.py
# (validate_outbound_host), shared with the nl-query inline-DSN path so the two
# zero-trust checks cannot drift. Imported above as _validate_ssh_host.
