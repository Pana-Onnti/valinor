      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {recentClients.length > 0 && (
          ...
          >
            ...
            <div className="flex items-start justify-between mb-6 flex-wrap gap-4">
              ...
              <Link
                href="/new-analysis"
                className="flex items-center gap-2 px-5 py-2.5 bg-violet-600 hover:bg-violet-700 text-white rounded-xl text-sm font-semibold transition-all shadow-sm shadow-violet-500/20"
              >
        ...
        {recentClients.length === 0 && (
          ...
          >
            ...
            <Link
              href="/new-analysis"
              className="inline-flex items-center gap-2 px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl text-base font-semibold transition-all shadow-lg shadow-indigo-500/25"
            >
